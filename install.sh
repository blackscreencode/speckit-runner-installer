...
# speckit-runner installer (blackscreencode org)
# Usage: curl -fsSL https://raw.githubusercontent.com/blackscreencode/speckit-runner-installer/main/install.sh | bash

REPO="blackscreencode/speckit-runner"
